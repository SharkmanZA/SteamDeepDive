...
input_file = 'data/steam_reviews.json'       # Replace with the actual file path if different
output_file = 'data/steam_reviews_1.json'
...
input_file = 'data/steam_reviews_1.json'
output_file = 'data/steam_reviews_2.json'
...
input_file =  'data/steam_reviews_2.json'
output_file = 'data/steam_reviews_3.json'
